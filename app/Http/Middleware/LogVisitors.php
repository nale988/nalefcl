...
class LogVisitors
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $ismobile = isset($_SERVER['HTTP_USER_AGENT']) && preg_match('!(tablet|pad|mobile|phone|symbian|android|ipod|ios|blackberry|webos)!i', $_SERVER['HTTP_USER_AGENT']) ? true : false;
        dd($ismobile);
        die;
