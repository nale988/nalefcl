            ...
            @if(Illuminate\Support\Facades\Auth::check())
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <div class="row">
                            <div class="col-auto">
                                <small><a href="{{ route('todos.create') }}" class="text-white">Dodaj novo</a></small>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled">
                    ...
                    @if(Illuminate\Support\Facades\Auth::check())
                        @if(App\UserRole::where('user_id', Auth::user() -> id)->first()->worktimes==1)
                            <li>
                                <a class="nav-link" href="{{ route('worktimes.index') }}">
                                    ...
                                    <span class="text-white">Pregled radnih sati</span>
                                </a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('worktimes.create') }}">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-clock" fill="white" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm8-7A8 8 0 1 1 0 8a8 8 0 0 1 16 0z"/>
                                        <path fill-rule="evenodd" d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
                                    </svg>
                                    <span class="text-white">Unos radnih sati</span>
                                </a>
                            </li>
                        @endif
                    @endif
          ...
          <div class="container">
            ...
            @csrf
                <div class="form-group" action="{{ route('search') }}" method="GET">
                    <input class="form-control form-control-sm mx-2" type="text" name="searchvalue" placeholder="Traži poziciju..." arial-label="Search" >
