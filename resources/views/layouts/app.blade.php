        ...
        <div class="collapse bg-dark" id="navbarHeader">
          <div class="container">
            ...
            <div class="col-sm-4 py-4">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="{{ url('/spareparts/create') }}" title="Dodaj novi rezervni dio">
                    ...
                    <li>
                        <a href="{{ url('advancedsearch') }}" title="Dodaj novi rezervni dio">
                    ...
                    <h4 class="text-white"><u>Info</u></h4>
                    <ul class="list-unstyled">
                    <li>
                    @guest
                    <li class="nav-item">
