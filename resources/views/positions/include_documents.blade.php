    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-2 text-right">
                ...
                <a href="#" data-toggle="modal" data-target="#modal-{{ $file -> id }}" >
                ...
                <div class="modal fade col" id="modal-{{ $file -> id }}" tabindex="-1" role="dialog" aria-labelledby="desc-{{ $file -> id }}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modal-{{ $file -> id }}">Ukloni dokument</h5>
