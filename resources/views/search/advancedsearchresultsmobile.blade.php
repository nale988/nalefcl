...
<div class="card">
    ...
    <div class="card-body">
        ...
        @foreach($spareparttypes as $spareparttype)
            ...
            <div class="row">
                <div class="col text-truncate">
                    <small>{{ $sparepart -> description }}</small>
                </div>
            </div>
            <div class="row">
                <div class="col-5 text-muted text-truncate">
                    <small>{{ $sparepart -> catalogue_number }}</small>
                </div>

                <div class="col text-right">
                    <a href="{{ route('spareparts.edit', $sparepart -> id)}}" class="btn btn-primary btn-sm" title="Uredi rezervni dio">
